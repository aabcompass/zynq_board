...
{
	*(u32*)(XPAR_AXI_DATA_PROVIDER_Z3_0_BASEADDR+4*REGW_DATAPROV_PMTZERO_01) = artix0_bits | artix1_bits<<16;
	*(u32*)(XPAR_AXI_DATA_PROVIDER_Z3_0_BASEADDR+4*REGW_DATAPROV_PMTZERO_2) = artix2_bits;
}
...
{
	if(en) {
		*(u32*)(XPAR_AXI_DATA_PROVIDER_Z3_0_BASEADDR+4*REGW_DATAPROV_GTU_PERIOD) = 1; /*1.05 MHz GTU*/
		*(u32*)(XPAR_AXI_DATA_PROVIDER_Z3_0_BASEADDR+4*REGW_DATAPROV_CLKEN) |= (1<<BIT_ART_CLKEN);
		*(u32*)(XPAR_AXI_DATA_PROVIDER_Z3_0_BASEADDR+4*REGW_DATAPROV_CLKEN) |= (1<<BIT_ART_GTUEN);
	}
	else {
		*(u32*)(XPAR_AXI_DATA_PROVIDER_Z3_0_BASEADDR+4*REGW_DATAPROV_CLKEN) &= ~(1<<BIT_ART_CLKEN);
	}
