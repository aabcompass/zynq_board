...
#define ZYNQ3_VER_STRING "v5.12.05"
...
#define FILENAME_HVLOG			"hv_%08d.dat" /*hv_00000000.dat,hv_00000001.dat, ... */
#define FILENAME_HVLOG_FLIGHT	"hv_z%d_%s_%04d.dat"
...
#define TCP_CMD_HVPS_MAPPING		"hvps mapping %d %d %d %d %d %d %d %d %d"
...
#define TCP_CMD_HVPS_ADCV_LEN0		"hvps adcv len0 %d"
#define TCP_CMD_HVPS_ADCV_LEN1		"hvps adcv len1 %d"
#define TCP_CMD_HVPS_ADCV_NUM		"hvps adcv num %d"
...
#define TCP_CMD_L1_GLOB_TRG_CNT		"trg glob cnt?" /*returns the number of all trg pulses, generated by both L1 and KI trigger block */
