...
void FC_ResetSelfTrgCounter()
{
	*(u32*)(XPAR_AXIS_FLOW_CONTROL_D1_BASEADDR + REGW_CLR_FLAGS*4) |= BIT_FC_CLR_SELF_TRG_CNT;
	*(u32*)(XPAR_AXIS_FLOW_CONTROL_D1_BASEADDR + REGW_CLR_FLAGS*4) &= ~BIT_FC_CLR_SELF_TRG_CNT;
}
...
void FlowControlInit_D1()
{
	...
	*(u32*)(XPAR_AXIS_FLOW_CONTROL_D1_BASEADDR + REGW_PERIODIC_TRIG_PERIOD*4) = 500*100;//CLK_FREQ*N_FRAMES_PER_LIFECYCLE/(MAX_PACKETS_L1+1);//     /20000; //for testing
...
void D1_release()
{
	...
	*(u32*)(XPAR_AXIS_FLOW_CONTROL_D1_BASEADDR + REGW_EDGE_FLAGS*4) = BIT_FC_RELEASE;
	//print("R");
	//DelayZynq7000Ns(1000);
	//i++; // a small delay => 250 5ns clocks
	//i=0;
	*(u32*)(XPAR_AXIS_FLOW_CONTROL_D1_BASEADDR + REGW_EDGE_FLAGS*4) = 0;
}
