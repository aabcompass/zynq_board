...
int main () 
{
...

   {
      ...
      print("\r\n Running AxiDMASelfTestExample() for axi_dma_sc36...\r\n");

      status = AxiDMASelfTestExample(XPAR_AXI_DMA_SC36_DEVICE_ID);
...

   {
      ...
      print("\r\nRunning GpioOutputExample() for gpio_ctrl...\r\n");

      status = GpioOutputExample(XPAR_GPIO_CTRL_DEVICE_ID,32);
