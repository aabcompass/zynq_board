...
proc create_root_design { parentCell } {
  ...
  set Dout_Art [ create_bd_port -dir O -from 0 -to 0 Dout_Art ]
  ...
  # Create instance: c_counter_zynq, and set properties
  set c_counter_zynq [ create_bd_cell -type ip -vlnv xilinx.com:ip:c_counter_binary:12.0 c_counter_zynq ]
  ...
  # Create instance: xlslice_Zynq, and set properties
  set xlslice_Zynq [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xlslice_Zynq ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {0} \
   CONFIG.DIN_TO {0} \
   CONFIG.DIN_WIDTH {16} \
  ...
  connect_bd_net -net bitslip_sm_0_dataout0 [get_bd_pins bitslip_sm_0/dataout0] [get_bd_pins ila_0/probe0]
  connect_bd_net -net bitslip_sm_0_dataout1 [get_bd_pins bitslip_sm_0/dataout1] [get_bd_pins ila_0/probe1]
  connect_bd_net -net bitslip_sm_0_dataout2 [get_bd_pins bitslip_sm_0/dataout2] [get_bd_pins ila_0/probe2]
  connect_bd_net -net bitslip_sm_0_dataout3 [get_bd_pins bitslip_sm_0/dataout3] [get_bd_pins ila_0/probe3]
  connect_bd_net -net bitslip_sm_0_dataout4 [get_bd_pins bitslip_sm_0/dataout4] [get_bd_pins ila_0/probe4]
  connect_bd_net -net bitslip_sm_0_dataout5 [get_bd_pins bitslip_sm_0/dataout5] [get_bd_pins ila_0/probe5]
  connect_bd_net -net bitslip_sm_0_dataout6 [get_bd_pins bitslip_sm_0/dataout6] [get_bd_pins ila_0/probe6]
  connect_bd_net -net bitslip_sm_0_dataout7 [get_bd_pins bitslip_sm_0/dataout7] [get_bd_pins ila_0/probe7]
  connect_bd_net -net bitslip_sm_0_dataout8 [get_bd_pins bitslip_sm_0/dataout8] [get_bd_pins ila_0/probe8]
  connect_bd_net -net bitslip_sm_0_dataout9 [get_bd_pins bitslip_sm_0/dataout9] [get_bd_pins ila_0/probe9]
  connect_bd_net -net bitslip_sm_0_dataout10 [get_bd_pins bitslip_sm_0/dataout10] [get_bd_pins ila_0/probe10]
  connect_bd_net -net bitslip_sm_0_dataout11 [get_bd_pins bitslip_sm_0/dataout11] [get_bd_pins ila_0/probe11]
  connect_bd_net -net bitslip_sm_0_dataout12 [get_bd_pins bitslip_sm_0/dataout12] [get_bd_pins ila_0/probe12]
  connect_bd_net -net c_counter_binary_0_Q [get_bd_pins c_counter_zynq/Q] [get_bd_pins xlslice_Zynq/Din]
  connect_bd_net -net c_counter_binary_0_Q1 [get_bd_pins c_counter_binary_Art/Q] [get_bd_pins xlslice_Art/Din]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins c_counter_zynq/CLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK]
  connect_bd_net -net selectio_wiz_0_clk_out [get_bd_pins bitslip_sm_0/clk] [get_bd_pins c_counter_binary_Art/CLK] [get_bd_pins ila_0/clk] [get_bd_pins selectio_wiz_0/clk_div_out]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins selectio_wiz_0/io_reset] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_ports Dout_Art] [get_bd_pins xlslice_Art/Dout]
  connect_bd_net -net xlslice_Zynq_Dout [get_bd_ports Dout_0] [get_bd_ports Dout_1] [get_bd_ports Dout_2] [get_bd_ports Dout_3] [get_bd_pins xlslice_Zynq/Dout]
