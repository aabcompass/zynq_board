...
connect_bd_intf_net -intf_net [get_bd_intf_nets data_converter_1_m_axis] [get_bd_intf_pins data_converter_1/m_axis] [get_bd_intf_pins system_ila_0/SLOT_2_AXIS]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_intf_nets data_converter_1_m_axis]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets scurve_adder36_0_out_stream] [get_bd_intf_pins axis_data_fifo_2/S_AXIS] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_intf_nets scurve_adder36_0_out_stream]
  ...
  connect_bd_net -net axi_data_provider_z3_0_run [get_bd_pins axi_data_provider_z3_0/run_data_conv] [get_bd_pins bitslip_sm_0/run] [get_bd_pins bitslip_sm_1/run] [get_bd_pins bitslip_sm_2/run]
