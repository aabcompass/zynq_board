...
`define TV_IN_in_stream0_TDATA "./c.scurve_adder36.autotvin_in_stream0_V_data_V.dat"
`define INGRESS_STATUS_in_stream0_TDATA "./stream_ingress_status_in_stream0_V_data_V.dat"
`define TV_IN_in_stream0_TKEEP "./c.scurve_adder36.autotvin_in_stream0_V_keep_V.dat"
`define INGRESS_STATUS_in_stream0_TKEEP "./stream_ingress_status_in_stream0_V_keep_V.dat"
`define TV_IN_in_stream0_TSTRB "./c.scurve_adder36.autotvin_in_stream0_V_strb_V.dat"
`define INGRESS_STATUS_in_stream0_TSTRB "./stream_ingress_status_in_stream0_V_strb_V.dat"
`define TV_IN_in_stream0_TUSER "./c.scurve_adder36.autotvin_in_stream0_V_user_V.dat"
`define INGRESS_STATUS_in_stream0_TUSER "./stream_ingress_status_in_stream0_V_user_V.dat"
`define TV_IN_in_stream0_TLAST "./c.scurve_adder36.autotvin_in_stream0_V_last_V.dat"
`define INGRESS_STATUS_in_stream0_TLAST "./stream_ingress_status_in_stream0_V_last_V.dat"
`define TV_IN_in_stream0_TID "./c.scurve_adder36.autotvin_in_stream0_V_id_V.dat"
`define INGRESS_STATUS_in_stream0_TID "./stream_ingress_status_in_stream0_V_id_V.dat"
`define TV_IN_in_stream0_TDEST "./c.scurve_adder36.autotvin_in_stream0_V_dest_V.dat"
`define INGRESS_STATUS_in_stream0_TDEST "./stream_ingress_status_in_stream0_V_dest_V.dat"
...
module AESL_axi_s_in_stream0 (
    input clk,
    input reset,
    output [128 - 1:0] TRAN_in_stream0_TDATA,
    output [16 - 1:0] TRAN_in_stream0_TKEEP,
    output [16 - 1:0] TRAN_in_stream0_TSTRB,
    output [6 - 1:0] TRAN_in_stream0_TUSER,
    ...
    reg [128 - 1:0] in_stream0_TDATA_write_data;
    reg in_stream0_TDATA_read_en;
    wire [128 - 1:0] in_stream0_TDATA_read_data;
    
    fifo #(4320, 128) fifo_in_stream0_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    reg [16 - 1:0] in_stream0_TKEEP_write_data;
    reg in_stream0_TKEEP_read_en;
    wire [16 - 1:0] in_stream0_TKEEP_read_data;
    
    fifo #(4320, 16) fifo_in_stream0_TKEEP (
        .reset(1'b0),
        .write_clock(clk),
    ...
    reg [16 - 1:0] in_stream0_TSTRB_write_data;
    reg in_stream0_TSTRB_read_en;
    wire [16 - 1:0] in_stream0_TSTRB_read_data;
    
    fifo #(4320, 16) fifo_in_stream0_TSTRB (
        .reset(1'b0),
        .write_clock(clk),
    ...
    reg [6 - 1:0] in_stream0_TUSER_write_data;
    reg in_stream0_TUSER_read_en;
    wire [6 - 1:0] in_stream0_TUSER_read_data;
    
    fifo #(4320, 6) fifo_in_stream0_TUSER (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(4320, 1) fifo_in_stream0_TLAST (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(4320, 5) fifo_in_stream0_TID (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(4320, 6) fifo_in_stream0_TDEST (
        .reset(1'b0),
        .write_clock(clk),
    ...
    initial begin : AXI_stream_driver_in_stream0_TDATA
        ...
        reg [1047:0] token_ingress_status;
