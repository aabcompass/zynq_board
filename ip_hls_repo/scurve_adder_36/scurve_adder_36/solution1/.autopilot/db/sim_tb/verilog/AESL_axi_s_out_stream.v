...
`define TV_OUT_out_stream_TDATA "./impl_rtl.scurve_adder36.autotvout_out_stream_V_data_V.dat"
`define EGRESS_STATUS_out_stream_TDATA "./stream_egress_status_out_stream_V_data_V.dat"
`define TV_OUT_out_stream_TKEEP "./impl_rtl.scurve_adder36.autotvout_out_stream_V_keep_V.dat"
`define EGRESS_STATUS_out_stream_TKEEP "./stream_egress_status_out_stream_V_keep_V.dat"
`define TV_OUT_out_stream_TSTRB "./impl_rtl.scurve_adder36.autotvout_out_stream_V_strb_V.dat"
`define EGRESS_STATUS_out_stream_TSTRB "./stream_egress_status_out_stream_V_strb_V.dat"
`define TV_OUT_out_stream_TUSER "./impl_rtl.scurve_adder36.autotvout_out_stream_V_user_V.dat"
`define EGRESS_STATUS_out_stream_TUSER "./stream_egress_status_out_stream_V_user_V.dat"
`define TV_OUT_out_stream_TLAST "./impl_rtl.scurve_adder36.autotvout_out_stream_V_last_V.dat"
`define EGRESS_STATUS_out_stream_TLAST "./stream_egress_status_out_stream_V_last_V.dat"
`define TV_OUT_out_stream_TID "./impl_rtl.scurve_adder36.autotvout_out_stream_V_id_V.dat"
`define EGRESS_STATUS_out_stream_TID "./stream_egress_status_out_stream_V_id_V.dat"
`define TV_OUT_out_stream_TDEST "./impl_rtl.scurve_adder36.autotvout_out_stream_V_dest_V.dat"
...
module AESL_axi_s_out_stream (
    input clk,
    input reset,
    input [512 - 1:0] TRAN_out_stream_TDATA,
    input [64 - 1:0] TRAN_out_stream_TKEEP,
    input [64 - 1:0] TRAN_out_stream_TSTRB,
    input [6 - 1:0] TRAN_out_stream_TUSER,
    ...
    reg [512 - 1:0] out_stream_TDATA_write_data;
    reg out_stream_TDATA_read_en;
    wire [512 - 1:0] out_stream_TDATA_read_data;
    
    fifo #(144, 512) fifo_out_stream_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    reg [64 - 1:0] out_stream_TKEEP_write_data;
    reg out_stream_TKEEP_read_en;
    wire [64 - 1:0] out_stream_TKEEP_read_data;
    
    fifo #(144, 64) fifo_out_stream_TKEEP (
        .reset(1'b0),
        .write_clock(clk),
    ...
    reg [64 - 1:0] out_stream_TSTRB_write_data;
    reg out_stream_TSTRB_read_en;
    wire [64 - 1:0] out_stream_TSTRB_read_data;
    
    fifo #(144, 64) fifo_out_stream_TSTRB (
        .reset(1'b0),
        .write_clock(clk),
    ...
    reg [6 - 1:0] out_stream_TUSER_write_data;
    reg out_stream_TUSER_read_en;
    wire [6 - 1:0] out_stream_TUSER_read_data;
    
    fifo #(144, 6) fifo_out_stream_TUSER (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(144, 1) fifo_out_stream_TLAST (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(144, 5) fifo_out_stream_TID (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(144, 6) fifo_out_stream_TDEST (
        .reset(1'b0),
        .write_clock(clk),
