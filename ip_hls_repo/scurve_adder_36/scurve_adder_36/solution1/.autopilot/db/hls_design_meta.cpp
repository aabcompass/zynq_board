...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("in_stream0_TDATA", 128, hls_in, 0, "axis", "in_data", 1),
	Port_Property("in_stream0_TVALID", 1, hls_in, 6, "axis", "in_vld", 1),
	Port_Property("in_stream0_TREADY", 1, hls_out, 6, "axis", "in_acc", 1),
	Port_Property("in_stream0_TKEEP", 16, hls_in, 1, "axis", "in_data", 1),
	Port_Property("in_stream0_TSTRB", 16, hls_in, 2, "axis", "in_data", 1),
	Port_Property("in_stream0_TUSER", 8, hls_in, 3, "axis", "in_data", 1),
	Port_Property("in_stream0_TLAST", 1, hls_in, 4, "axis", "in_data", 1),
	Port_Property("in_stream0_TID", 5, hls_in, 5, "axis", "in_data", 1),
	Port_Property("in_stream0_TDEST", 6, hls_in, 6, "axis", "in_data", 1),
	Port_Property("out_stream_TDATA", 512, hls_out, 7, "axis", "out_data", 1),
	Port_Property("out_stream_TVALID", 1, hls_out, 13, "axis", "out_vld", 1),
	Port_Property("out_stream_TREADY", 1, hls_in, 13, "axis", "out_acc", 1),
	Port_Property("out_stream_TKEEP", 64, hls_out, 8, "axis", "out_data", 1),
	Port_Property("out_stream_TSTRB", 64, hls_out, 9, "axis", "out_data", 1),
	Port_Property("out_stream_TUSER", 8, hls_out, 10, "axis", "out_data", 1),
...
const char* HLS_Design_Meta::dut_name = "scurve_adder36";
