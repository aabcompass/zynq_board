...
#ifndef __scurve_adder36_murcU__HH__
#define __scurve_adder36_murcU__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(scurve_adder36_murcU) {
    ...
    SC_CTOR(scurve_adder36_murcU):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
