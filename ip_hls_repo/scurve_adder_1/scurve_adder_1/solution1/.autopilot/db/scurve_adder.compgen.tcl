...
set ID 1
set MemName scurve_adder_sum_bkb
...
# Memory (RAM/ROM)  definition:
set ID 2
set MemName scurve_adder_dub_dEe
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 2
set AddrRange 32
...
# Memory (RAM/ROM)  definition:
set ID 3
set MemName scurve_adder_dub_eOg
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 5
set AddrRange 32
...
# Memory (RAM/ROM)  definition:
set ID 4
set MemName scurve_adder_dub_fYi
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 6
set AddrRange 32
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { in_stream0_TDATA { I 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { in_stream0_TKEEP { I 2 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { in_stream0_TSTRB { I 2 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { in_stream0_TUSER { I 2 vector } } \
} "
} else {
