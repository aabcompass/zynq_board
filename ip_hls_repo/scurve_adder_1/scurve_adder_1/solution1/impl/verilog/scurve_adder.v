...
(* CORE_GENERATION_INFO="scurve_adder,hls_ip_2018_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z035ffg676-2,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=3.769500,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=4,HLS_SYN_DSP=0,HLS_SYN_FF=940,HLS_SYN_LUT=1153}" *)
...
reg   [0:0] exitcond_flatten_reg_522;
reg    out_stream_TDATA_blk_n;
reg    ap_enable_reg_pp2_iter2;
wire    ap_block_pp2_stage0;
reg   [0:0] exitcond_reg_603;
reg   [0:0] exitcond_reg_603_pp2_iter1_reg;
reg    ap_enable_reg_pp2_iter3;
reg   [0:0] exitcond_reg_603_pp2_iter2_reg;
...
reg   [0:0] exitcond_flatten_reg_522_pp1_iter1_reg;
...
reg   [15:0] N_ADDS_read_reg_504;
wire   [5:0] i_3_fu_352_p2;
wire    ap_CS_fsm_state2;
wire   [20:0] tmp_fu_364_p3;
reg   [20:0] tmp_reg_517;
wire    ap_CS_fsm_state3;
wire   [0:0] exitcond_flatten_fu_371_p2;
reg   [0:0] exitcond_flatten_reg_522_pp1_iter2_reg;
reg   [0:0] exitcond_flatten_reg_522_pp1_iter3_reg;
wire   [20:0] indvar_flatten_next_fu_376_p2;
reg    ap_enable_reg_pp1_iter0;
wire   [5:0] i_1_mid2_fu_388_p3;
reg   [5:0] i_1_mid2_reg_531;
wire   [5:0] i_5_fu_396_p2;
wire   [7:0] tmp_2_fu_429_p1;
reg   [7:0] tmp_2_reg_541;
reg   [7:0] tmp_2_reg_541_pp1_iter2_reg;
reg   [7:0] phitmp_reg_546;
reg   [7:0] phitmp_reg_546_pp1_iter2_reg;
reg   [4:0] sum_pix1_ch0_addr_2_reg_551;
reg   [4:0] sum_pix1_ch0_addr_2_reg_551_pp1_iter2_reg;
reg   [4:0] sum_pix1_ch0_addr_2_reg_551_pp1_iter3_reg;
reg   [4:0] sum_pix2_ch0_addr_2_reg_557;
reg   [4:0] sum_pix2_ch0_addr_2_reg_557_pp1_iter2_reg;
reg   [4:0] sum_pix2_ch0_addr_2_reg_557_pp1_iter3_reg;
wire   [31:0] tmp_8_fu_446_p2;
reg   [31:0] tmp_8_reg_563;
wire   [31:0] tmp_11_fu_455_p2;
reg   [31:0] tmp_11_reg_568;
wire    ap_CS_fsm_state9;
wire   [1:0] dub_pix_ch0_user_V_q0;
reg   [1:0] sum_pix_tot_user_V_reg_588;
wire    ap_CS_fsm_state10;
wire   [4:0] dub_pix_ch0_id_V_q0;
reg   [4:0] sum_pix_tot_id_V_reg_593;
wire   [5:0] dub_pix_ch0_dest_V_q0;
reg   [5:0] sum_pix_tot_dest_V_reg_598;
wire   [0:0] exitcond_fu_461_p2;
wire   [5:0] i_4_fu_467_p2;
reg    ap_enable_reg_pp2_iter0;
wire   [0:0] tmp_last_V_fu_479_p2;
reg   [0:0] tmp_last_V_reg_622;
reg   [0:0] tmp_last_V_reg_622_pp2_iter1_reg;
wire   [63:0] tmp_data_V_1_fu_497_p2;
...
wire   [63:0] tmp_1_fu_358_p1;
wire   [63:0] tmp_s_fu_402_p1;
wire   [63:0] tmp_3_fu_473_p1;
wire    ap_block_pp2_stage0_01001;
wire   [0:0] exitcond2_fu_382_p2;
wire   [31:0] tmp_9_fu_443_p1;
wire   [31:0] tmp_10_fu_452_p1;
wire   [63:0] tmp_5_fu_485_p3;
wire  signed [63:0] tmp_6_fu_493_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (exitcond_flatten_fu_371_p2 == 1'd0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state10)) begin
        i_2_reg_325 <= 6'd0;
    end else if (((1'b0 == ap_block_pp2_stage0_11001) & (exitcond_fu_461_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp2_stage0) & (ap_enable_reg_pp2_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        i_reg_292 <= 6'd0;
    end else if (((exitcond1_fu_346_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp2_stage0_11001) & (exitcond_reg_603 == 1'd0) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0))) begin
        reg_336 <= sum_pix1_ch0_q1;
    end else if (((1'b0 == ap_block_pp1_stage0_11001) & (exitcond_flatten_reg_522_pp1_iter1_reg == 1'd0) & (ap_enable_reg_pp1_iter2 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (exitcond_flatten_fu_371_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (exitcond_flatten_reg_522 == 1'd0) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        phitmp_reg_546 <= {{in_stream0_V_data_V_0_data_out[15:8]}};
        sum_pix1_ch0_addr_2_reg_551 <= tmp_s_fu_402_p1;
        sum_pix2_ch0_addr_2_reg_557 <= tmp_s_fu_402_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (exitcond_flatten_reg_522_pp1_iter2_reg == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp2_stage0_11001) & (exitcond_fu_461_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp2_stage0))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        tmp_reg_517[20 : 5] <= tmp_fu_364_p3[20 : 5];
    end
end

always @ (*) begin
    if ((exitcond_flatten_fu_371_p2 == 1'd1)) begin
...
always @ (*) begin
    if ((~((out_stream_V_dest_V_1_ack_in == 1'b0) | (out_stream_V_id_V_1_ack_in == 1'b0) | (out_stream_V_last_V_1_ack_in == 1'b0) | (out_stream_V_user_V_1_ack_in == 1'b0) | (out_stream_V_strb_V_1_ack_in == 1'b0) | (out_stream_V_keep_V_1_ack_in == 1'b0) | (out_stream_V_data_V_1_ack_in == 1'b0)) & (1'b1 == ap_CS_fsm_state15))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((ap_enable_reg_pp1_iter0 == 1'b0) & (ap_enable_reg_pp1_iter2 == 1'b0) & (ap_enable_reg_pp1_iter1 == 1'b0) & (ap_enable_reg_pp1_iter4 == 1'b0) & (ap_enable_reg_pp1_iter3 == 1'b0))) begin
        ap_idle_pp1 = 1'b1;
    end else begin
        ap_idle_pp1 = 1'b0;
    end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        ...
        dub_pix_ch0_dest_V_address0 = tmp_s_fu_402_p1;
    end else begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state9) | ((1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0)))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (exitcond_flatten_reg_522 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        ...
        dub_pix_ch0_id_V_address0 = tmp_s_fu_402_p1;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        ...
        dub_pix_ch0_user_V_address0 = tmp_s_fu_402_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp1_stage0) & (exitcond_flatten_reg_522 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (*) begin
    if ((((1'b0 == ap_block_pp2_stage0) & (exitcond_reg_603_pp2_iter2_reg == 1'd0) & (ap_enable_reg_pp2_iter3 == 1'b1)) | ((1'b0 == ap_block_pp2_stage0) & (exitcond_reg_603_pp2_iter1_reg == 1'd0) & (ap_enable_reg_pp2_iter2 == 1'b1)))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp2_stage0_11001) & (exitcond_reg_603_pp2_iter1_reg == 1'd0) & (ap_enable_reg_pp2_iter2 == 1'b1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        sum_pix1_ch0_address0 = tmp_s_fu_402_p1;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        sum_pix1_ch0_address0 = tmp_1_fu_358_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp2_stage0) & (1'b1 == ap_CS_fsm_pp2_stage0) & (ap_enable_reg_pp2_iter0 == 1'b1))) begin
        sum_pix1_ch0_address1 = tmp_3_fu_473_p1;
...
always @ (*) begin
    if (((exitcond1_fu_346_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (exitcond_flatten_reg_522_pp1_iter3_reg == 1'd0) & (ap_enable_reg_pp1_iter4 == 1'b1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        sum_pix2_ch0_address0 = tmp_s_fu_402_p1;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        sum_pix2_ch0_address0 = tmp_1_fu_358_p1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp2_stage0) & (1'b1 == ap_CS_fsm_pp2_stage0) & (ap_enable_reg_pp2_iter0 == 1'b1))) begin
        sum_pix2_ch0_address1 = tmp_3_fu_473_p1;
    end else if (((1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter4 == 1'b1))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp1_stage0 : begin
            if ((~((ap_enable_reg_pp1_iter1 == 1'b0) & (exitcond_flatten_fu_371_p2 == 1'd1) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b0 == ap_block_pp1_stage0_subdone)) & ~((ap_enable_reg_pp1_iter4 == 1'b1) & (ap_enable_reg_pp1_iter3 == 1'b0) & (1'b0 == ap_block_pp1_stage0_subdone)))) begin
                ap_NS_fsm = ap_ST_fsm_pp1_stage0;
            end else if ((((ap_enable_reg_pp1_iter1 == 1'b0) & (exitcond_flatten_fu_371_p2 == 1'd1) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b0 == ap_block_pp1_stage0_subdone)) | ((ap_enable_reg_pp1_iter4 == 1'b1) & (ap_enable_reg_pp1_iter3 == 1'b0) & (1'b0 == ap_block_pp1_stage0_subdone)))) begin
        ...
        ap_ST_fsm_pp2_stage0 : begin
            if ((~((ap_enable_reg_pp2_iter1 == 1'b0) & (exitcond_fu_461_p2 == 1'd1) & (ap_enable_reg_pp2_iter0 == 1'b1) & (1'b0 == ap_block_pp2_stage0_subdone)) & ~((ap_enable_reg_pp2_iter2 == 1'b0) & (ap_enable_reg_pp2_iter3 == 1'b1) & (1'b0 == ap_block_pp2_stage0_subdone)))) begin
                ap_NS_fsm = ap_ST_fsm_pp2_stage0;
            end else if ((((ap_enable_reg_pp2_iter2 == 1'b0) & (ap_enable_reg_pp2_iter3 == 1'b1) & (1'b0 == ap_block_pp2_stage0_subdone)) | ((ap_enable_reg_pp2_iter1 == 1'b0) & (exitcond_fu_461_p2 == 1'd1) & (ap_enable_reg_pp2_iter0 == 1'b1) & (1'b0 == ap_block_pp2_stage0_subdone)))) begin
...
always @ (*) begin
    ap_block_pp1_stage0_11001 = ((exitcond_flatten_reg_522 == 1'd0) & (in_stream0_V_data_V_0_vld_out == 1'b0) & (ap_enable_reg_pp1_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp1_stage0_subdone = ((exitcond_flatten_reg_522 == 1'd0) & (in_stream0_V_data_V_0_vld_out == 1'b0) & (ap_enable_reg_pp1_iter1 == 1'b1));
end
...
always @ (*) begin
    ap_block_pp2_stage0_11001 = (((1'b1 == ap_block_state14_io) & (ap_enable_reg_pp2_iter3 == 1'b1)) | ((1'b1 == ap_block_state13_io) & (ap_enable_reg_pp2_iter2 == 1'b1)));
end

always @ (*) begin
    ap_block_pp2_stage0_subdone = (((1'b1 == ap_block_state14_io) & (ap_enable_reg_pp2_iter3 == 1'b1)) | ((1'b1 == ap_block_state13_io) & (ap_enable_reg_pp2_iter2 == 1'b1)));
end
...
always @ (*) begin
    ap_block_state13_io = ((exitcond_reg_603_pp2_iter1_reg == 1'd0) & (out_stream_V_data_V_1_ack_in == 1'b0));
end

assign ap_block_state13_pp2_stage0_iter2 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state14_io = ((exitcond_reg_603_pp2_iter2_reg == 1'd0) & (out_stream_V_data_V_1_ack_in == 1'b0));
end

assign ap_block_state14_pp2_stage0_iter3 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state15 = ((out_stream_V_dest_V_1_ack_in == 1'b0) | (out_stream_V_id_V_1_ack_in == 1'b0) | (out_stream_V_last_V_1_ack_in == 1'b0) | (out_stream_V_user_V_1_ack_in == 1'b0) | (out_stream_V_strb_V_1_ack_in == 1'b0) | (out_stream_V_keep_V_1_ack_in == 1'b0) | (out_stream_V_data_V_1_ack_in == 1'b0));
end

assign ap_block_state4_pp1_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state5_pp1_stage0_iter1 = ((exitcond_flatten_reg_522 == 1'd0) & (in_stream0_V_data_V_0_vld_out == 1'b0));
end
...
assign exitcond1_fu_346_p2 = ((i_reg_292 == 6'd32) ? 1'b1 : 1'b0);

assign exitcond2_fu_382_p2 = ((i_1_reg_314 == 6'd32) ? 1'b1 : 1'b0);

assign exitcond_flatten_fu_371_p2 = ((indvar_flatten_reg_303 == tmp_reg_517) ? 1'b1 : 1'b0);

assign exitcond_fu_461_p2 = ((i_2_reg_325 == 6'd32) ? 1'b1 : 1'b0);

assign i_1_mid2_fu_388_p3 = ((exitcond2_fu_382_p2[0:0] === 1'b1) ? 6'd0 : i_1_reg_314);

assign i_3_fu_352_p2 = (i_reg_292 + 6'd1);

assign i_4_fu_467_p2 = (i_2_reg_325 + 6'd1);

assign i_5_fu_396_p2 = (6'd1 + i_1_mid2_fu_388_p3);
...
assign indvar_flatten_next_fu_376_p2 = (indvar_flatten_reg_303 + 21'd1);
...
assign tmp_10_fu_452_p1 = phitmp_reg_546_pp1_iter2_reg;

assign tmp_11_fu_455_p2 = (tmp_10_fu_452_p1 + reg_341);

assign tmp_1_fu_358_p1 = i_reg_292;

assign tmp_2_fu_429_p1 = in_stream0_V_data_V_0_data_out[7:0];

assign tmp_3_fu_473_p1 = i_2_reg_325;

assign tmp_5_fu_485_p3 = {{reg_341}, {32'd0}};

assign tmp_6_fu_493_p1 = $signed(reg_336);

assign tmp_8_fu_446_p2 = (tmp_9_fu_443_p1 + reg_336);

assign tmp_9_fu_443_p1 = tmp_2_reg_541_pp1_iter2_reg;

assign tmp_data_V_1_fu_497_p2 = (tmp_6_fu_493_p1 | tmp_5_fu_485_p3);

assign tmp_fu_364_p3 = {{N_ADDS_read_reg_504}, {5'd0}};

assign tmp_last_V_fu_479_p2 = ((i_2_reg_325 == 6'd31) ? 1'b1 : 1'b0);

assign tmp_s_fu_402_p1 = i_1_mid2_reg_531;

always @ (posedge ap_clk) begin
    tmp_reg_517[4:0] <= 5'b00000;
end
